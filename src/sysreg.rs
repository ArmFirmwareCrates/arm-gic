...
write_sysreg32!(icc_igrpen0_el1, 0, c12, c12, 6, write_icc_igrpen0_el1, IccIgrpenEl1);
write_sysreg32!(icc_igrpen1_el1, 0, c12, c12, 7, write_icc_igrpen1_el1, IccIgrpenEl1);
read_sysreg32!(icc_igrpen1_el3, 6, c12, c12, 7, read_icc_igrpen1_el3, IccIgrpen1El3);
write_sysreg32!(icc_igrpen1_el3, 6, c12, c12, 7, write_icc_igrpen1_el3, IccIgrpen1El3);
...
read_sysreg32!(icc_sre_el2, 0, c12, c12, 5, read_icc_sre_el2, IccSreEl23);
write_sysreg32!(icc_sre_el2, 0, c12, c12, 5, write_icc_sre_el2, IccSreEl23);
read_sysreg32!(icc_sre_el3, 0, c12, c12, 5, read_icc_sre_el3, IccSreEl23);
write_sysreg32!(icc_sre_el3, 0, c12, c12, 5, write_icc_sre_el3, IccSreEl23);
...
impl Sgir {
    ...
    pub fn all(intid: IntId) -> Self {
        Self((u64::from(intid.sgi_index()) << Self::INTID_SHIFT) | Self::IRM)
    }
    ...
    pub fn list(
        ...
        Self(
            (u64::from(intid.sgi_index()) << Self::INTID_SHIFT)
